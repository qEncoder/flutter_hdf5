...
class H5PBindings {
  ...
  H5PBindings(DynamicLibrary HDF5Lib)
      : __create = HDF5Lib.lookup<NativeFunction<h5pcreate_c>>('H5Pcreate').asFunction(),
        __close = HDF5Lib.lookup<NativeFunction<h5pclose_c>>('H5Pclose').asFunction(),
        __getLayout = HDF5Lib.lookup<NativeFunction<h5pget_layout_c>>('H5Pget_layout').asFunction(),
        __getChunk = HDF5Lib.lookup<NativeFunction<h5pget_chunk_c>>('H5Pget_chunk').asFunction(),
        __getChunkCache = HDF5Lib.lookup<NativeFunction<h5pget_chunk_cache_c>>('H5Pget_chunk_cache').asFunction(),
        __setChunkCache = HDF5Lib.lookup<NativeFunction<h5pset_chunk_cache_c>>('H5Pset_chunk_cache').asFunction(),
        __setFaplRos3 = HDF5Lib.lookup<NativeFunction<H5Pset_fapl_ros3_c>>('H5Pset_fapl_ros3').asFunction(),
        __setFaplRos3Token = HDF5Lib.lookup<NativeFunction<H5Pset_fapl_ros3_token_c>>('H5Pset_fapl_ros3_token').asFunction(),
  ...
  void getChunkCache(int dapl_id, Pointer<Uint64> rdcc_nslots, Pointer<Uint64> rdcc_nbytes, Pointer<Double> rdcc_w0) {
  ...
  void setChunkCache(int dapl_id, int rdcc_nslots, int rdcc_nbytes, double rdcc_w0) {
