...
| **complex64** | - Special | - NO | Read requires unpacking COMPOUND type |
| **complex128** | - Special | - NO | Read requires unpacking COMPOUND type |
...
-  Complex reading requires data copy (HDF5 COMPOUND type structure)
-  Currently macOS only (other platforms untested)
