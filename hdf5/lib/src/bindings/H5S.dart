...
class H5SBindings{
  ...
  H5SBindings(DynamicLibrary HDF5Lib):
    close = HDF5Lib.lookup<NativeFunction<H5Sclose_c>>('H5Sclose').asFunction(),
    getSimpleExtentNdims = HDF5Lib.lookup<NativeFunction<H5Sget_simple_extent_ndims_c>>('H5Sget_simple_extent_ndims').asFunction(),
    getSimpleExtentDims = HDF5Lib.lookup<NativeFunction<H5Sget_simple_extent_dims_c>>('H5Sget_simple_extent_dims').asFunction();
  }